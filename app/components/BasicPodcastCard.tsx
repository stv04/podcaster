...
export default function BasicPodcastCard({podcast}: {podcast: Entry}) {
    return <div className="max-w-sm rounded overflow-hidden shadow-md hover:shadow-lg my-3" key={podcast.id.attributes?.["im:id"]}>
        <Link href={`/podcast/${podcast.id.attributes?.["im:id"]}`}>
            ...
            <div className="px-6 py-4">
                <div className="font-bold text-xl mb-2">{podcast.title.label} ${podcast.id.attributes?.["im:id"]}</div>
